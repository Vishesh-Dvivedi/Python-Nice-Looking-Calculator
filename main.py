...
class Calculator(Tk):
    def __init__(self):
        ...
        self.bind("<Key-Delete>", self.backspace)
    ...
    def Initialize(self):
        ...
        self.output_entry.configure(bg=self.OUTPUT_BG)
        ...
        self.button1.configure(bg=self.BUTTON_BG, width=self.BUTTON_WIDTH, height=self.BUTTON_HEIGHT)
        self.button1.grid(row=0, column=0, sticky=NSEW)

        self.button2 = Button(self.button_frame, font=self.BUTTON_FONT, text="2", command=partial(self.print_number, "2"))
        self.button2.configure(bg=self.BUTTON_BG, width=self.BUTTON_WIDTH, height=self.BUTTON_HEIGHT)
        self.button2.grid(row=0, column=1, sticky=NSEW)

        self.button3 = Button(self.button_frame, font=self.BUTTON_FONT, text="3", command=partial(self.print_number, "3"))
        self.button3.configure(bg=self.BUTTON_BG, width=self.BUTTON_WIDTH, height=self.BUTTON_HEIGHT)
        ...
        self.button_add.configure(bg=self.BUTTON_BG, width=self.BUTTON_WIDTH, height=self.BUTTON_HEIGHT)
        ...
        self.button4.configure(bg=self.BUTTON_BG, width=self.BUTTON_WIDTH, height=self.BUTTON_HEIGHT)
        ...
        self.button5.configure(bg=self.BUTTON_BG, width=self.BUTTON_WIDTH, height=self.BUTTON_HEIGHT)
        ...
        self.button6.configure(bg=self.BUTTON_BG, width=self.BUTTON_WIDTH, height=self.BUTTON_HEIGHT)
        ...
        self.button_subtract.configure(bg=self.BUTTON_BG, width=self.BUTTON_WIDTH, height=self.BUTTON_HEIGHT)
        ...
        self.button7.configure(bg=self.BUTTON_BG, width=self.BUTTON_WIDTH, height=self.BUTTON_HEIGHT)
        ...
        self.button8.configure(bg=self.BUTTON_BG, width=self.BUTTON_WIDTH, height=self.BUTTON_HEIGHT)
        ...
        self.button9.configure(bg=self.BUTTON_BG, width=self.BUTTON_WIDTH, height=self.BUTTON_HEIGHT)
        ...
        self.button_multiply.configure(bg=self.BUTTON_BG, width=self.BUTTON_WIDTH, height=self.BUTTON_HEIGHT)
        ...
        self.button_dot.configure(bg=self.BUTTON_BG, width=self.BUTTON_WIDTH, height=self.BUTTON_HEIGHT)
        ...
        self.button0.configure(bg=self.BUTTON_BG, width=self.BUTTON_WIDTH, height=self.BUTTON_HEIGHT)
        ...
        self.button_equal.configure(bg=self.BUTTON_BG, width=self.BUTTON_WIDTH, height=self.BUTTON_HEIGHT)
        ...
        self.button_divide.configure(bg=self.BUTTON_BG, width=self.BUTTON_WIDTH, height=self.BUTTON_HEIGHT)
